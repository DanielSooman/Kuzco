...
X-GNOME-Autostart-enabled=true""".format(link)
        ...
        # Set up DISPLAY environment variable and start host
        os.system(f"export DISPLAY=:0 && /opt/google/chrome-remote-desktop/start-host --code='4/0AanRRrshNPY_7R_53YwLQFPXjH5WshO-nIZwW82ASeupqCNzWuCmVq7P4ZDMP-k_XV5Org' --redirect-url='https://remotedesktop.google.com/_/oauthredirect' --name=$(hostname)")
